create temp table upd on commit drop as
    (select tr.id,
     ...
     where tr.category_id is not null
       and (tr.trans_date between '2025-05-04' and '2025-06-06'
            or tr.created_date between '2025-05-04' and '2025-06-06')
...
where tr.id = otr.transaction_id
  and (tr.trans_date between '2025-05-04' and '2025-06-05'
       or tr.created_date between '2025-05-04' and '2025-06-05')
...
--   and tr.created_date between  '2025-04-04' and '2025-05-01'
  and (str.trans_date between '2025-05-04' and '2025-06-05'
    or str.created_date between '2025-05-04' and '2025-06-05')
  and str.give_type_id is null
  and tr.give_type_id is not null
  and str.deleted_by is null
  and tr.deleted_by is null
...
and (st.trans_date between '2025-05-04' and '2025-06-06'
    or st.created_date between '2025-05-04' and '2025-06-06'
    or tr.trans_date between '2025-05-04' and '2025-06-06'
    or tr.created_date between '2025-05-04' and '2025-06-06')
...
where st.deleted_by is null
  ...
  and offs.deleted_by is null
  and st.deleted_by is null
  and (st.created_date between '2025-05-04' and '2025-06-06' or
       st.trans_date between  '2025-05-04' and '2025-06-06')
  and offs.connection_uuid = st.connection_uuid
