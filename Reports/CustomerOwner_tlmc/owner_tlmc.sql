...
join lateral (
    select *
    from prx_proprietor_information ow
    where ow.customer_id = cu.id
      and ow.deleted_by is null
    order by ow.start_date desc
    limit 1
...
set --start_date = t.date_,
    end_date = (t.date_ - interval '1 DAY')::date,
