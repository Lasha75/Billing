...
select pm.bank_id,
       ...
       pm.customer_number,
        ...
        pm.telasi_amount
from prx_payment pm
where pm.payment_id in ('6771253452 ');--pm.internal_bank_id = 'LB' and reporting_date = '2025-03-08';--pm.payment_id in ('1');-- --
...
where tr.payment_doc_number in ('6771253452')--tr.bank_code = 'LB' and reporting_date = '2025-03-27'--
